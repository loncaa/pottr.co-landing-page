...
export default function HeroHorizontal() {
  return (
    <div className="relative grid grid-rows-1 lg:grid-cols-2 gap-3">
      <div className="text-center lg:text-start m-auto lg:m-0 grid grid-cols-2 col-span-2">
        <h1 className="text-3xl font-semibold tracking-tight text-[#201515] sm:text-5xl col-span-2 md:col-span-1">
          Technologies
        </h1>
        <div className="grid grid-cols-1 lg:grid-cols-2 col-span-2">
          <div>
            <h4 className="max-w-xl mt-4 text-base tracking-tight text-gray-600">
              Here are the main technologies used in our projects. Don't see
              your technologies listed here? No problem – we've got it covered!
            </h4>
